...
class TrainModel(object):
    def __init__(self, file_id, logger):
        ...
        checkpoint = torch.load("/home/n504/checkpoints/0.0_cifar100/" + file_id + ".pt")
    ...
    def main(self, epoch):
        ...
        if test_loss / total < self.best_loss:
            ...
            torch.save({'model': self.net.state_dict(), 'loss': self.best_loss}, "/home/n504/checkpoints/0.0_cifar100/" + self.file_id + ".pt.fullepoch")
            self.counter = 0
        else:
            self.counter += 1
